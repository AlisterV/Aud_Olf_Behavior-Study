...
function dprime_soundsmellperformance_psychocurve()
...
for k = 1 : length(theFiles)
  ...
  ydprime=dprime(percorrarray',FAarray,nTarget,nDistract);
  ydprimeodor=dprime(percorrarrayodor',FAarrayodor,nTargetodor,nDistractodor);
end
