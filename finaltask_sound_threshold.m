function [soundthresh] = finaltask_sound_threshold(x_sound,x_sound_size,x_conc,x_conc_size,theFiles)
...
for k = 1 : length(theFiles)
  ...
  [params,mdl,threshold,sensitivity,fmcon,minfun,pthresh] = fitLogGridsound(x_sound(:),y_sound(:));
...
xlim([0 2])
xticks([0 1 2])
xlabel('Sound Level Threshold')
ylabel('Sound Level')
title('Sound Level Thresholds by Session')
end
