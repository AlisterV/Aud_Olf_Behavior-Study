...
%This code compares the psychometric curves for the sound only test
%sessions and the sound only with no odor trials of a sound+odor test
...
function sound_only_comparison_psychocurve()
